...
export default function GroupMessageScreen() {
  ...
  const messages = useSelector((state) => state.GroupChatSlice.messages);
  ...
  return (
    <div className="group-message-screen-parent">
      <div className="group-message-screen-person-details">
        <div className="group-message-screen-profile-picture">
          <img src={state?.receipientDetails?.profilePicture} />
        </div>
        <div className="group-message-screen-name-and-status">
          <h1>{state?.receipientDetails?.name}</h1>
          <h6>Online</h6>
        </div>
      </div>

      <div className="group-message-screen-all-messages">
      ...
      <form onSubmit={sendMessage} className="group-message-screen-send-message">
        <div className="group-message-screen-send-attachment">
          {openFileAttachment && (
            <div className="group-message-screen-select-attachment">
              <div className="group-message-screen-select-picture">
                <input
                  type="file"
                  accept="image/*"
                  style={{ display: "none" }}
              ...
              <div className="group-message-screen-select-document">
                <input
                  type="file"
                  accept=".pdf"
                  style={{ display: "none" }}
        ...
        <div className="group-message-screen-type-message">
          <input
        ...
        <button type="submit" className="group-message-screen-send-message-button">
          <span>SEND</span>
        </button>
      </form>
    </div>
